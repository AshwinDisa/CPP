...
int main(int argc, char **argv){
	ros::init(argc, argv, "controller_robot_3");
	ros::NodeHandle nh;
	vel_pub = nh.advertise<geometry_msgs::Twist>("/robot3/cmd_vel", 100);
	pos_sub = nh.subscribe("/robot3/odom", 10, poseCallback);
	scan_sub = nh.subscribe("/robot3/scan", 10, scanCallback);

	float goals[18][3] = {{0,5,1}, {1,5,1}, {1,9,1}, {2,9,1}, {2,5,1}, {3,5,1}, {3,9,1}, {4,9,1}, {4,5,1}, {5,5,1}, {5,9,1}, {6,9,1}, {6,6,1}, {6,7,1}, {7,7,1}, {7,9,1}, {8,9,1}, {8,8,1}};
