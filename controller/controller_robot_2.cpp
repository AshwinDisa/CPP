...
int main(int argc, char **argv){
	ros::init(argc, argv, "controller_robot_2");
	ros::NodeHandle nh;
	vel_pub = nh.advertise<geometry_msgs::Twist>("/robot2/cmd_vel", 100);
	pos_sub = nh.subscribe("/robot2/odom", 10, poseCallback);
	scan_sub = nh.subscribe("/robot2/scan", 10, scanCallback);

	float goals[20][3] = {{9,8,1}, {9,7,1}, {8,7,1}, {8,6,1}, {7,6,1}, {7,5,1}, {6,5,1}, {6,4,1}, {5,4,1}, {5,0,1}, {6,0,1}, {6,3,1}, {7,3,1}, {7,4,1}, {8,4,1}, {8,5,1}, {8,2,1}, {7,2,1}, {7,0,1}, {8,0,1}};
